...
import {
  ...
  ConfigReserva, DisponibilidadResponse, InfoNegocioPublico, ResumenDashboard,
} from '../models';
...
export class ReservaApiService {
  ...
  completarCita(id: number, idNegocio: number) {
    return this.http.post<ApiResponse<Cita>>(
      `${this.base}/citas/${id}/completar`, { id_negocio: idNegocio },
    );
  }
